...
export const getNonceToSign = functions.region("europe-west1").https.onRequest((request, response) =>
...
export const verifySignedMessage = functions.region("europe-west1").https.onRequest(
    (request, response) =>
        cors(request, response, async () => {
